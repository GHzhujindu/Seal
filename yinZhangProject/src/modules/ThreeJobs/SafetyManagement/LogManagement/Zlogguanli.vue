<template>
  <div class="Zlogguanli">
    ...
    <el-pagination background prev-text="上一页" next-text="下一页" @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="currentPage1" :page-size="100" layout="total, prev, pager, next" :total="1000">
    </el-pagination>
  </div>
</template>
...
export default {
  methods: {
    Newfile() {
      this.$router.push({ path: '/component/Zryqx' })
    },
    onSubmit() {
      alert("查询")
    },
